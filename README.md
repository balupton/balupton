Benjamin furthers [the humanities](https://en.wikipedia.org/wiki/Humanities) and [the commons](https://en.wikipedia.org/wiki/Information_commons#Software_commons) using the monikers [balupton](https://github.com/balupton) and [bevry](https://github.com/bevry).
